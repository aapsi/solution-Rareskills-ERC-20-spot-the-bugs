...
contract ERC20Test is Test {
    Challlenge01 public erc20;

    function setUp() public {
        erc20 = new Challlenge01("Test", "TEST");
    }
    ...
    function test_ERC20_transfer_reverts_sender_address_0() public {
        vm.expectRevert(
            abi.encodeWithSelector(
                Challlenge01.InvalidSender.selector,
                address(0)
            )
        );
        vm.prank(address(0));
    ...
    function test_ERC20_transfer_reverts_receiver_is_address_0() public {
        vm.expectRevert(
            abi.encodeWithSelector(
                Challlenge01.InvalidReceiver.selector,
                address(0)
            )
        );
    ...
    function test_ERC20_transfer_reverts_insufficient_sender_balance() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(
                Challlenge01.InsufficientBalance.selector,
                address(123),
                0,
                20e18
            )
    ...
    function test_ERC20_approve_revert_approver_address_0() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(
                Challlenge01.InvalidApprover.selector,
                address(0)
            )
        );
    ...
    function test_ERC20_approve_revert_receiver_address_0() public {
        vm.expectRevert(
            abi.encodeWithSelector(
                Challlenge01.InvalidSpender.selector,
                address(0)
            )
        );
        vm.prank(address(123));
    ...
    function test_ERC20_transferFrom_revert_spender_invalid_alowance() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(
                Challlenge01.InsufficientAllowance.selector,
                address(1234),
                1e18,
                2e18
            )
